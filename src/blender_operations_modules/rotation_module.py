...
class RotatePanel(Panel):
    ...
    def draw(self, context):
        ...
        row = layout.row()
        row.operator(
            "model_rotator.rotate_object_cw_x_degree", text="顺时针旋转 X by Degree"
        )
        row.operator(
            "model_rotator.rotate_object_cw_y_degree", text="顺时针旋转 Y by Degree"
        )
        row.operator(
            "model_rotator.rotate_object_cw_z_degree", text="顺时针旋转 Z by Degree"
        )
